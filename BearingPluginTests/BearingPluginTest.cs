...
namespace BearingPluginTests
{
    ...
    public class BearingPluginTest
    {
        ...
        public void TestBearingParamsRightProp(RollingElementForm rollingElementForm, double bearingWidth, double innerRimDiam, double outerRimDiam, double rimsThickness, double ballDiam)
        {
            var unused = new BearingParametrs(rollingElementForm, bearingWidth, innerRimDiam, outerRimDiam, rimsThickness, ballDiam);
        }
        ...
        public void TestBearingNegativeParams(RollingElementForm rollingElementForm, double bearingWidth, double innerRimDiam, double outerRimDiam, double rimsThickness, double ballDiam)
        {
            NUnit.Framework.Assert.That(() =>
            {
                new BearingParametrs(rollingElementForm, bearingWidth, innerRimDiam, outerRimDiam, rimsThickness, ballDiam);
